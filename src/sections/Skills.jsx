...
export function Skills() {
  ...
  return (
    ...
    >
      <p className="font-semibold text-bg-secondary mt-4 mb-4">Minhas experiências</p>
      <h2 className="font-extrabold text-4xl mb-4">Linguagens e tecnologias</h2>
      <p className="mb-4">Aqui estão as linguagens e tecnologias que eu tenho contato</p>
